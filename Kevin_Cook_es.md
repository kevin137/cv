...
- Desarrollo integral de hardware desde el concepto inicial con el cliente, diseño de prototipos funcionales, validación, hasta su producción en serie. 
- Diseño de circuitos, captura de esquemáticos, rutado de circuitos impresos con Altium, Zuken y KiCAD
...
- Modelado estadístico con redes bayesianas, visualización e inferencia usando el entorno Python/NumPy/Jupyter aplicado a datos industriales, simulación de circuitos, automatización del diseño y resultados de validación de productos
- Desarrollo de ensayos automatizados usando HTML5+JavaScript, Python+Robot Framework, Ruby, Lua, TCP/IP y dispositivos personalizados
- Caracterización y validación de productos utilizando automatización exhaustiva, técnicas de RF, cámaras anecoicas de EMC, BERT, reflectometría en el dominio del tiempo, pruebas de alimentación, térmicas y de vibración
...
|     |     |
| :-- | :-- |
| **Lenguajes de Programación**   | Python+NumPy, R, HTML5+JavaScript, C/C++, Ruby+Cucumber, LabWindows/CVI, Java, Markdown |
| **Diseño Electrónico**         | Altium, KiCAD, Zuken (CADSTAR, SI Verify), Mentor Graphics (DxDesigner, PADS Router), LTSpice, Hyperlynx, Polar |
| **Ingeniería**                 | SolidWorks, FreeCAD, SketchUp, MATLAB/Octave/Simulink, Excel |
| **Vídeo y Redes**              | Certificados en HEVC, HLS/MPEG-DASH, G.984 GPON; certificados Telcordia en TCP/IP, DWDM, SONET/SDH, T1/E1 |
| **Sistemas y Plataformas**     | Linux, Windows, Docker, VMware, Vagrant, EC2 |
| **Lenguajes Naturales**        | Inglés (nativo), español (fluido) |
...
Desarrollo de una nueva generación de plataformas de hardware para sensores industriales, edge computing y redes OT:

***Aingura Impulse* industrial distributed data acquisition and machine learning system**  
Responsable del desarrollo de hardware para una línea integrada de productos de elementos modulares de adquisición de datos (DAQ) y procesamiento. Selección de plataformas de computación de próxima generación, incluyendo la evaluación comparativa (benchmarking) de subsistemas de CPU y memoria.

***Aingura IPNI* edge computing node for infrastructure**  
Rediseñar una unidad de computación modular para infraestructuras en exteriores en colaboración con proveedores de ensamblaje y desarrolladores de firmware para una operación remota no supervisada. Lideré el desarrollo de un nuevo modelo de chasis.

***Aingura LAPA* series of DAQ interfaces**  
Desarrollo de electrónica de adquisición de datos específicamente para puentes y pasos elevados. Actualmente implantada en Massachusetts y España.

### Ikusi  *- Donostia-San Sebastián, España*

#### Jefe de Proyectos en Ikusi Multimedia [actualmente integrado en Fagor Electrónica] (2012-2020)

**Gestión de un proyecto para el desarrollo de una cabecera de televisión conectada a la nube según especificaciones del cliente**  
La gestión de este proyecto incluía hardware, software y nube, coordinando los plazos.

**Gestión del desarrollo de hardware y diseño mecánico para una nueva cabecera multimedia**  
Desarrollo de la arquitectura modular de una cabecera incluyendo un sistema de red novedoso y económico, basado en USB embebido: varios productos actuales se basan en la plataforma y sus derivados. Implementé un nuevo sistema térmico para la arquitectura. Dirigí el desarrollo de todos los circuitos impresos clave del sistema, integrando un nuevo microprocesador, FPGA, DRAM, e IPcores. Colaboré con los fabricantes de los circuitos impresos para optimizar el rendimiento y el coste del hardware, con los desarrolladores del firmware para racionalizar y modularizar el devicetree, y con los diseñadores mecánicos para mejorar la EMC.

**Dirección del diseño de un subsistema de red para una plataforma de televisión**  
Especifiqué, diseñé e implementé un sistema de red optimizado para el streaming de servicios de televisión, desde el hardware hasta la VLAN, los integrados PHY en las tarjetas de los nodos, el backplane, hasta el ASIC central. El sistema, basado en Gigabit Ethernet, integra el ASIC de conmutación en hardware modular hecho a medida y forma el núcleo de comunicaciones para la cabecera premium de Ikusi. El módulo central también incluye un microprocesador y una FPGA para la gestión de la cabecera. Gestioné el desarrollo del firmware para switch ASIC por un contratista externo. Desarrollé tanto los protocolos de validación como las pruebas de producción, incluyendo hardware y software a medida escrito en Ruby.

#### Técnico I+D en Ikusi Multimedia [actualmente integrado en Fagor Electrónica] (2007-2012)
...
#### Ingeniero Eléctrico, Unidad de "High Performance Adapters" (2005-2007)
...
- Visión por computador y redes neuronales convolucionales
- Deep Learning y Bioinformática
- Series Temporales y Optimización
...
**Cursos avanzados en telecomunicaciones:**  
